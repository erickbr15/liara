...
public class PineconeService : IPineconeService
{
    ...
    public PineconeService(IOptions<PineconeOptions> pineconeOptionsService, IHttpProxy httpProxy)
    {
        _pineconeOptions = pineconeOptionsService?.Value ?? throw new ArgumentNullException(nameof(pineconeOptionsService));
